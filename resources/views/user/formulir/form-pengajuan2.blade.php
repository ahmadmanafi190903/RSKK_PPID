          ...
          <form action="/pengajuan/create" class="row" id="contact-form" method="POST">
            ...
            <div class="col-md-6 col-12">
              <div class="single-personal-info">
                ...
                <input type="text" id="name" placeholder="Masukan Nama Lengkap" name="nama" value="{{ $applicant->nama }}{{ old('nama') }}">
                @error('nama')
            ...
            <div class="col-md-6 col-12">
              <div class="single-personal-info">
                ...
                <input type="email" id="email" placeholder="Masukan Alamat Email" name="email" value="{{ $applicant->email }}{{ old('email') }}">
                @error('email')
                  <div class="alert alert-danger">{{ $message }}</div>
                @enderror 
              </div>
            ...
            <div class="col-md-6 col-12">
              <div class="single-personal-info">
                ...
                <input type="text" id="phone" placeholder="Masuk no telepon" name="no_telepon" value="{{ $applicant->no_telepon }}{{ old('no_telepon') }}" oninput="inputPhone()">
                @error('no_telepon')
                  <div class="alert alert-danger">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="col-md-6 col-12">
              <div class="single-personal-info">
                <label for="work">Pekerjaan</label>
                  <input type="text" id="work" placeholder="Masukan Pekerjaan" name="pekerjaan" value="{{ $applicant->pekerjaan }}{{ old('pekerjaan') }}">
                  @error('pekerjaan')
                    <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
              </div>
            ...
            <div class="col-md-12 col-12">
              <div class="single-personal-info mb-0">
                ...
                <textarea id="address" placeholder="Masukan Alamat" name="alamat" >{{ $applicant->alamat }}{{ old('alamat') }}</textarea>
                @error('alamat')
                  <div class="alert alert-danger">{{ $message }}</div>
                @enderror
              </div>
