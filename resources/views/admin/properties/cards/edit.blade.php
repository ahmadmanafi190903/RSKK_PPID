...
@section('content')
  <div class="content-wrapper">
    ...
    <section class="content">
      <form action="/cards/{{ $item->id }}" method="post" enctype="multipart/form-data">
      @csrf
      @method('patch')
      <div class="row">
              ...
              <div class="card-body table-responsive p-3">
                <div class="mb-4">
                  ...
                  <div class="input-group mb-2">
                    <img src="/storage/{{ $item->icon }}" class="w-100 mb-2" id="previewImage">
                ...
                <a href="/cards" class="btn btn-secondary">kembali</a>
