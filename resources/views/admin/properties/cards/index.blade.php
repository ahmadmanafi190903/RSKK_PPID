        ...
        <div class="row mb-2">
          <div class="col-12 d-flex justify-content-between">
            ...
            @if (Auth::user()->role == 'super_admin')
              <a href="/cards/create" class="btn btn-primary"><i class="nav-icon fas fa-plus"></i></a>
            @endif
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <tbody id="contentArea">
                  @foreach ($cards as $item)
                    <tr>
                      ...
                      <td class="align-middle">
                        @if (Auth::user()->role == 'super_admin')
                          <a href="cards/{{ $item->id }}/edit" class="btn btn-warning my-1">
                            <i class="nav-icon fas fa-pencil"></i>
                          </a>
                          <form action="cards/{{ $item->id }}" method="post">
                            @csrf
                            @method('delete')
