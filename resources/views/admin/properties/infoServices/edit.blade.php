  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Info Layanan</h1>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <form action="/info_services/{{ $item->id }}" method="post" enctype="multipart/form-data">
      @csrf
      @method('patch')
      <div class="row">
              ...
              <div class="card-body table-responsive p-3">
                <div class="mb-4">
                  ...
                  <div class="input-group mb-2">
                    <img src="/storage/{{ $item->icon }}" class="w-100" id="previewImage">
                ...
                <div class="mb-4">
                  ...
                  <input class="w-100 form-control" type="text" id="nama_button" name="nama_button" value="{{ old('nama_button') ?? $item->nama_button }}">
                  @error('nama_button')
                    <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                </div>
