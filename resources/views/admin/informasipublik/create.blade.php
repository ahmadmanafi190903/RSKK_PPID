            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-3">
                ...
                <div class="mb-4">
                  ...
                  <input class="w-100 form-control" type="text" value="{{ old('pejabat_penguasa_informasi') }}" id="pejabat_penguasa_informasi" name="pejabat_penguasa_informasi">
                ...
                <div class="mb-4">
                  ...
                  <input class="w-100 form-control" type="text" value="{{ old('penanggung_jawab_informasi') }}" id="penanggung_jawab_informasi" name="penanggung_jawab_informasi">
                ...
                <div class="mb-4">
                  ...
                  <div class="form-group">
                    <div class="custom-control custom-radio">
                      <input class="custom-control-input" type="radio" id="cetak_ya" name="bentuk_informasi_cetak" value="1" {{ old('bentuk_informasi_cetak') == '1' ?'checked' : '' }}>
                      <label for="cetak_ya" class="custom-control-label form-check-label">Ya</label>
                    </div>
                    <div class="custom-control custom-radio">
                      <input class="custom-control-input" type="radio" id="cetak_tidak" name="bentuk_informasi_cetak" value="0" {{ old('bentuk_informasi_cetak') == '0' ?'checked' : '' }}>
                ...
                <div class="mb-4">
                  ...
                  <div class="form-group">
                    <div class="custom-control custom-radio">
                      <input class="custom-control-input" type="radio" id="digital_ya" name="bentuk_informasi_digital" value="1" {{ old('bentuk_informasi_digital') == '1' ?'checked' : '' }}>
                      <label for="digital_ya" class="custom-control-label form-check-label">Ya</label>
                    </div>
                    <div class="custom-control custom-radio">
                      <input class="custom-control-input" type="radio" id="digital_tidak" name="bentuk_informasi_digital" value="0" {{ old('bentuk_informasi_digital') == '0' ?'checked' : '' }}>
                ...
                {{-- <div class="mb-4">
                  ...
                  <textarea class="w-100 form-control" name="alamat"  cols="30" id="alamat"></textarea>
                  @error('alamat')
                    <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                </div>
                <div class="mb-4">
                  ...
                  <input class="w-100 form-control" type="text" value="" id="nik" name="nik" inputmode="numeric" oninput="inputNik()">
                  @error('nik')
                    <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                </div>
                <div class="mb-4">
                  ...
                  <div> 
                    <img src="{{ asset('storage/') }}" alt="" width="200px">
                  </div>
                ...
                <div class="mb-4">
                  ...
                  <select class="custom-select" id="kategori_id" name="kategori_id">
                    ...
                    @foreach ($categories as $item)
                      {{-- <option value="{{ $item->id }}" {{ $item->id == $information->kategori_id ?'selected' : '' }}>{{ $item->memperoleh_informasi }}</option> --}}
